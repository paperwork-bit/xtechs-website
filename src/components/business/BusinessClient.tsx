...
const benefits = [
  ...
  },
  {
    ...
    description: "Most commercial installations completed within 3-5 days."
  },
  {
    icon: Users,
    title: "Local Support",
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            >
              ...
              >
                Cut operating costs with onsite clean energy
              </AnimatedUnderline>
            </motion.h1>
            ...
            >
              Professional commercial energy solutions from solar panels and battery storage to EV charging and electrical work. Reduce operating costs, improve power quality, and future-proof your business.
            </motion.p>
            ...
            >
              ...
              <Button asChild variant="outline">
                <Link 
                  ...
                  onClick={() => trackCalendlyBooking('business-hero', 'commercial-consultation')}
                >
                  Book Consultation
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
          ...
          >
            <motion.div variants={shouldAnimate ? itemVariants : undefined} className="text-center mb-12">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-3">
                Why Choose xTechs for Business?
              </h2>
              <p className="text-base text-gray-600 max-w-2xl mx-auto">
                We're committed to delivering the highest quality commercial energy solutions with exceptional service and support.
              </p>
            </motion.div>
