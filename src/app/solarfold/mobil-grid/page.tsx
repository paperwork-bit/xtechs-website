    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative grid grid-cols-1 lg:grid-cols-2 min-h-[60vh]">
        <div className="relative h-[320px] lg:h-[60vh]">
          <Image src="/products/mobil-grid/1.webp" alt="Mobil‑Grid® solar container" fill className="object-cover" />
      ...
      <section id="gallery" className="bg-gray-50 py-14 md:py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-3">
            <ImageAutoSlider
              images={[
                { src: "/products/mobil-grid/1.webp", alt: "Mobil‑Grid — container" },
                { src: "/products/mobil-grid/2.webp", alt: "Mobil‑Grid — deployment" },
                { src: "/products/mobil-grid/3.webp", alt: "Mobil‑Grid — site view" },
                { src: "/products/mobil-grid/4.webp", alt: "Mobil‑Grid — detail" },
              ]}
              speedSec={22}
              size="md"
              direction="left"
