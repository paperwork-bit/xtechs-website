    ...
    <div className="min-h-screen">
      ...
      <div className="bg-blue-600 text-white py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-4">PV & Battery Hub</h1>
          <p className="text-center text-lg opacity-90 max-w-2xl mx-auto">
            Discover our comprehensive solar and battery solutions designed for Victorian homes and businesses
          </p>
        </div>
      </div>
